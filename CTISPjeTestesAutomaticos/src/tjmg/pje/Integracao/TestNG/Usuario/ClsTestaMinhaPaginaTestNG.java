...
public class ClsTestaMinhaPaginaTestNG extends ClsPrintScreenBase
{
	...
	/**
	 * Este caso de teste tem o objetivo de realizar a validação da funcionalidade do login de usuarios na aplicação, tempo aceitavel de 5 Segundos
